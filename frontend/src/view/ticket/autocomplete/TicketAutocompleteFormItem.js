...
import TicketFormModal from 'view/ticket/form/TicketFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/ticket/ticketSelectors';

class TicketAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
